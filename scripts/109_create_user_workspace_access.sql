-- ============================================================================
-- CREATE USER WORKSPACE ACCESS TABLE
-- Allows admins to restrict which workspaces regular users can see
-- Uses opt-in approach: users with NO entries see ALL workspaces
-- ============================================================================
...
-- 5. Update workspace RLS policy to include user workspace restrictions
...
-- Create new consolidated policy with opt-in workspace restrictions
...
COMMENT ON POLICY "workspaces_select_with_restrictions" ON public.workspaces 
IS 'Opt-in workspace restrictions: users see all workspaces by default, unless they have specific assignments.';

-- 6. Update projects RLS policy similarly
...
COMMENT ON POLICY "projects_select_with_restrictions" ON public.projects 
IS 'Opt-in workspace restrictions for projects.';
